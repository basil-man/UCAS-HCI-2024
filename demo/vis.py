...
def img2video(video_path, output_dir):
    ...
    # 创建视频剪辑并写入文件
    video_clip = ImageSequenceClip(names, fps=fps)
    video_clip.write_videofile(os.path.join(output_dir, f"{video_name}.mp4"), codec="libx264")
...
def generate(input):
    ...
    parser.add_argument(
        "--mode", type=str, default="deep_squat", help="The mode of analysis (e.g., 硬拉, deep_squat, 卧推)"
    )
